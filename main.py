...
def draw_snake(snake_body,screen, grid_size):
...
def draw_game_over_screen(screen, screen_width,screen_height,score):
   screen.fill((0, 0, 0))
   font = pygame.font.SysFont('arial', 40)
...
def display_score(font,screen, score, highest_score):
...
def main():
    ...
    while running:
        ...
        if game_state == "start_menu":
            draw_start_menu(screen,screen_width,screen_height)
        ...
        if keys[pygame.K_SPACE]:
            ...
            draw_game_over_screen(screen, screen_width,screen_height,score)
        keys = pygame.key.get_pressed()
        if keys[pygame.K_r]:
            game_state = "start_menu"
            score = 0
        if keys[pygame.K_q]:
            ...
            display_score(font,screen, score, highest_score)
            draw_snake(snake_body,screen, grid_size)
